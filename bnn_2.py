...
def main(argv):
  ...
  with tf.Session() as sess:
    ...
    for step in range(FLAGS.max_steps):
      ...
      if step % 100 == 0:
        loss_value, accuracy_value, food = sess.run(
            [elbo_loss, accuracy, neural_net.losses], feed_dict={handle: train_handle})
        print("Step: {:>3d} Loss: {:.3f} Accuracy: {:.3f} food: {} ".format(
            step, loss_value, accuracy_value, food))
